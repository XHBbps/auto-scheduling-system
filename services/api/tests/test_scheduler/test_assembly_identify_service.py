...
async def test_identify_assemblies(db_session):
    bom_rows = [
        BomRelationSrc(
            ...
            bom_component_desc="机身体总成MC1-80",
            bom_level=1,
            is_self_made=False,
            is_top_level=True,
            part_type="虚拟件",
        ...
        BomRelationSrc(
            ...
            plant="1000",
            material_no="MACH001",
            bom_component_no="COMP003",
            bom_component_desc="润滑MC1-80",
            bom_level=1,
            is_self_made=False,
            is_top_level=True,
            part_type="虚拟件",
        ...
        BomRelationSrc(
            ...
            plant="1000",
            material_no="MACH001",
            bom_component_no="COMP004",
            bom_component_desc="平垫圈MC1-80",
            bom_level=1,
            is_self_made=True,
            is_top_level=True,
            part_type="自产件",
        ...
        BomRelationSrc(
            ...
            plant="1000",
            material_no="COMP001",
            bom_component_no="COMP001-CHILD",
            bom_component_desc="机身体焊接件MC1-80",
            bom_level=2,
            is_self_made=True,
            is_top_level=False,
            part_type="自产件",
